    ...
    <div>
        ...
        <el-form :model="form" ref="form"   :rules="rules">
             <el-row>
                ...
                <el-col :span="3">
                    <el-form-item>
                    <el-button  type="primary"  @click="compare" :loading="btu_loading" >对决</el-button>
...
<script>
import { getTeamValues,getTeamValues_all,requestCompare } from '../request/api';
export default {
    created(){
    ...
    drawline(team1,team2){
      var url = team1+"/vs/"+team2+"/eighttimes"
        let self = this;
      console.log('正在请求');
      this.$ajax({
        type:'get',
    ...
    fulltable(team1,team2){
      var url = "stat/"+team1+"/vs/"+team2+"/table"
      let self = this;
      console.log('正在请求');
      this.$ajax({
        type:'get',
